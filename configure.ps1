...
Write-Output "Please enter following information to configure TestTemplate14 application for local use."
...
TestTemplate14DbConnection=Data Source=testtemplate14.sql;Initial Catalog=TestTemplate14Db;Encrypt=False
TestTemplate14Db_Migrations_Connection=Data Source=host.docker.internal,1433;Initial Catalog=TestTemplate14Db;Encrypt=False
...
# Database username
$db_user_default = "TestTemplate14Db_Login"
