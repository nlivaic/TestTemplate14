...
using TestTemplate14.Common.MessageBroker.Middlewares.ErrorLogging;
using TestTemplate14.Common.MessageBroker.Middlewares.Tracing;
using TestTemplate14.Core;
using TestTemplate14.Core.Events;
using TestTemplate14.Data;
using TestTemplate14.WorkerServices.FaultService;
using TestTemplate14.WorkerServices.FooService;
...
namespace TestTemplate14.WorkerServices
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                Log.Information("Starting up TestTemplate14 Worker Services.");
            ...
            {
                Log.Fatal(ex, "TestTemplate14 Worker Services failed at startup.");
            }
            finally
            {
                Log.CloseAndFlush();
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    {
                        var connString = new SqlConnectionStringBuilder(configuration["TestTemplate14DbConnection"]);
