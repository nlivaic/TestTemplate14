...
using TestTemplate14.Api.Helpers;
using TestTemplate14.Api.Middlewares;
using TestTemplate14.Application;
using TestTemplate14.Core;
using TestTemplate14.Data;

namespace TestTemplate14.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TestTemplate14DbContext>(options =>
            {
                var sqlConnectionStringBuilder = new SqlConnectionStringBuilder(_configuration["TestTemplate14DbConnection"] ?? string.Empty);
            ...
            services.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    "TestTemplate14OpenAPISpecification",
                    new OpenApiInfo
                    {
                        Title = "TestTemplate14 API",
                        Version = "v1",
                        Description = "This API allows access to TestTemplate14.",
                ...
                setupAction.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestTemplate14.Api.xml"));
            });
            ...
            services.AddCors(o => o.AddPolicy("TestTemplate14Client", builder =>
            {
            ...
            services.AddMassTransit(x =>
            {
                ...
                x.AddEntityFrameworkOutbox<TestTemplate14DbContext>(o =>
                {
            ...
            services.AddTestTemplate14ApplicationHandlers();
            ...
            services
                .AddHealthChecks()
                .AddDbContextCheck<TestTemplate14DbContext>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //    app.UseHsts();
            // }
            app.UseCors("TestTemplate14Client");
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/TestTemplate14OpenAPISpecification/swagger.json", "TestTemplate14 API");
