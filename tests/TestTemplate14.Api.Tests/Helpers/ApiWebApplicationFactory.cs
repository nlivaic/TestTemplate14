        ...
        IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                services.Remove(services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<TestTemplate14DbContext>)));
                ...
                var ctx = scopedServices.GetRequiredService<TestTemplate14DbContext>();
        ...
        public TestTemplate14DbContext CreateDbContext(ITestOutputHelper testOutput = null)
        {
        ...
        {
            private readonly DbContextOptions<TestTemplate14DbContext> _options;
            ...
            {
                _options = new DbContextOptionsBuilder<TestTemplate14DbContext>()
            ...
            public TestTemplate14DbContext BuildContext() =>
                new(_options);
        }
    }
}
